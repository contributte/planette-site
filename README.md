![](https://heatbadger.vercel.app/github/readme/contributte/planette-site/?deprecated=1)
...
Build site for development via `npm run dev`.

Build site for production via `npm run build`.
